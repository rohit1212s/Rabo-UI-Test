...
Feature: Create User
  ...
  Scenario Outline: Create a user account by entering the values
    ...
    Examples: 
      ...
      | Rohit     | kumar    | Notenplien | Den Haag | south Holland | 2555ZZ  | 0684105405 | 123456789 | rohit12117 |   123456 |  123456 | Your account was created successfully. You are now logged in. |
  ...
  Scenario Outline: Writing the all links name present in the home page into the notepad
    ...
    Examples: 
      ...
      | rohit12117 |   123456 | Rohit     | kumar    | Notenplien | Den Haag | south Holland | 2555ZZ  | 123456789 |
  ...
  Scenario Outline: Opening new Account from the home page link
    ...
    Examples: 
      ...
      | rohit12117 |   123456 | Rohit     | kumar    | Notenplien | Den Haag | south Holland | 2555ZZ  | 123456789 | SAVINGS     |
